...
material_compatible_map = {("ObjectsGDI",
                            "ObjectsAlien",
                            "ObjectsHuman",
                            "ObjectsNOD",
                            "cnc4_object_nod_infantry",
                            "cnc4_object_nod",
                            "cnc4_object_gdi"): "ObjectsAllied",
                           ("ObjectsGenericEnvMap",
                            "cnc4_object",
                            "cnc4_debris_fadeoff"): "ObjectsGeneric",
                           ("cnc4_object_gdi_proceduraldamage",
                            "cnc4_object_nod_proceduraldamage",
                            "cnc4_object_proceduraldamage"): "BuildingsGenericDamageFill",
                           ("cnc4_vfx",
                            ): "DefaultW3D"}
